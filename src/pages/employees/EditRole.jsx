...
const EditRole = () => {
	...
	return (
		<>
			<Helmet>
				<title>لوحة تحكم المعرفة | تعديل دور</title>
			</Helmet>
										...
										<nav aria-label='breadcrumb'>
											<ol className='breadcrumb'>
												<li className='breadcrumb-item'>
													<ArrowBack />
													<Link to='/employees/roles' className='me-2'>
														الأدوار الوظيفية
													</Link>
												</li>
													...
													<input
														...
														{...register("role_name", {
															...
															pattern: {
																...
																message:
																	" يجب أن يكون اسم الدور عبارة عن نصاّّ ولا يحتوي على حروف خاصه مثل الأقوس والرموز",
															},
														})}
													/>
													<br />
